...
function Home() {
  ...
  return (
    <div className="overflow-hidden w-full block md:flex justify-center bg-[#FFF7ED]">
      <div className="w-full">
        ...
        >
          <div className="w-full max-w-6xl px-6">
            ...
            {/* LỊCH SỬ QUÉT */}
            <ScanHistory inspectionType="GOM" />
          </div>
        </div>

        {/* MOBILE HISTORY */}
        <div className="md:hidden px-4 pb-[100px] mt-[100px] relative z-10">
          <ScanHistory inspectionType="GOM" />
        </div>
      </div>
    </div>
