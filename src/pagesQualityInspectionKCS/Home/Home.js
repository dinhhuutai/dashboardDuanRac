...
function Home() {
  ...
  const handleScanQR = () => {
    navigate(config.routes.qualityInspectionKCSResult);
  };
                ...
                <div>
                  ...
                  <div className="mt-6 flex gap-3 flex-wrap">
                    <button
                      ...
                      className="px-6 py-3 rounded-full bg-green-600 hover:bg-green-700 transition text-white flex items-center gap-2 shadow-lg"
                    >
                      <FaQrcode /> Quét QR KCS
                    </button>
                  </div>
                </div>
