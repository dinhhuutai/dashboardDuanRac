          ...
          <div className={`${barCard} relative h-[62px]`}>
            ...
            <div className="grid grid-cols-2 h-full items-center px-2">
              <div className="flex justify-center">
                <TabItem to={config.routes.inkCovPerOnFilm} label="Tính độ phủ" icon={<FaPercentage />} />
              </div>

              <div className="flex justify-center">
                <TabItem to={config.routes.uploadFileFilm} label="Tải file lên" icon={<FaPlusCircle />} />
              </div>
            </div>
          </div>
        </div>
