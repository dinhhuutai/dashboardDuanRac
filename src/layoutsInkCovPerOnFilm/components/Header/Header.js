    ...
    <header className={glassBar}>
      <div className="h-[64px] px-3 sm:px-5 hidden md:flex items-center justify-between gap-3 relative">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <Link to={config.routes.inkCovPerOnFilm} className="flex items-center gap-2 min-w-0">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <NavLink to={config.routes.inkCovPerOnFilm} end className={navBtn}>
            <FaPercentage className="text-[14px]" />
            Đo độ phủ
          </NavLink>

          <NavLink to={config.routes.uploadFileFilm} className={navBtn}>
          ...
          <div className="hidden md:block relative" ref={wrapRef}>
            ...
            >
              ...
              <span
                ...
                style={{
                  backgroundImage: `url(${user?.avatar || avatarInk})`,
