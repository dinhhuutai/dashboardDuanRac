...
//           <div className="p-4 md:p-4 bg-gradient-to-r from-green-50 via-emerald-50 to-white border-b border-slate-100">
...
//                   type="checkbox"
//                   checked={kcsOnly}
//                   onChange={(e) => setKcsOnly(e.target.checked)}
//                   className="h-3.5 w-3.5 accent-green-600"
//                 />
//                 Chỉ hiện KCS
//               </label>
