    ...
    <div className="relative flex flex-col items-center bg-white text-white p-4">
      ...
      <AnimatePresence>
        {resultVisible && jsonData && (
          <motion.div
            className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center p-6 z-[99999]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            onClick={() => {
          ...
          >
            <motion.div
              className="bg-white text-black rounded-xl shadow-xl space-y-4 w-full max-w-md mx-4 max-h-[80%] overflow-y-auto"
