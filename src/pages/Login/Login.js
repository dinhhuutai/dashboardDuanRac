...
//           className="group inline-flex w-full items-center justify-center gap-3 rounded-2xl bg-emerald-500/90 hover:bg-emerald-400 px-5 py-3 text-left shadow-lg shadow-emerald-500/40 transition-transform hover:-translate-y-0.5"
//         >
