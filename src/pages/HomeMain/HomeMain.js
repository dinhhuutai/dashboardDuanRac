...
// // import ThemeToggle from "./components/ThemeToggle"; // nếu cần bật lại toggle theme
...
//     // Khi vào trang HomeMain, kiểm tra xem user đã nhận thưởng hệ thống chưa
//   useEffect(() => {
//     const checkLuckyGift = async () => {
//       try {
//         // dùng BASE_URL giống phần modules ở trên
//         const res = await http.get(`${BASE_URL}/api/lucky-gift/status`);

//         if (res.data?.success && res.data.data) {
//           const { canSpin, luckyGiftClaimed } = res.data.data;

//           // chỉ mở modal nếu user chưa nhận thưởng (canSpin = true)
...
//             {/* Nếu muốn bật lại theme toggle thì đặt ở đây */}
