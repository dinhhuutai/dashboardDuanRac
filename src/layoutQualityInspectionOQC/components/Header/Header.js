    ...
    <header className={glassBar}>
      <div className="h-[64px] px-3 sm:px-5 hidden md:flex items-center justify-between gap-3 relative">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <Link to={config.routes.qualityInspectionOQC} className="flex items-center gap-2 min-w-0">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <NavLink to={config.routes.qualityInspectionOQC} end className={navBtn}>
            <FaHome className="text-[14px]" />
            Trang chủ
          </NavLink>

          <NavLink to={config.routes.qualityInspectionOQCManual} className={navBtn}>
