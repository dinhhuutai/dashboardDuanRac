          ...
          <div className={`${barCard} relative h-[62px]`}>
            ...
            <div className="grid grid-cols-3 h-full items-center px-2">
              ...
              <div className="flex justify-center">
                <TabItem to={config.routes.qualityInspectionOQC} label="Trang chủ" icon={<FaHome />} />
              </div>
              ...
              <div className="flex justify-center">
                <TabItem to={config.routes.qualityInspectionOQCManual} label="Nhập tay" icon={<FaEdit />} />
              </div>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 -top-6">
              <TabCenter to={config.routes.qualityInspectionOQCResult} label="Quét QR" icon={<FaQrcode />} />
            </div>
          </div>
        </div>
      </div>
