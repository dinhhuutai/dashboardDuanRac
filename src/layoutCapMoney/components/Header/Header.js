...
function Header() {
    ...
    <header className={glassBar}>
      <div className="h-[64px] px-3 sm:px-5 hidden md:flex items-center justify-between gap-3 relative">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <Link to={config.routes.capmoneyHome} className="flex items-center gap-2 min-w-0">
  ...
  <NavLink to={config.routes.capmoneyHome} end className={navBtn}>
    <FaHome className="text-[14px]" />
    Trang chủ
  </NavLink>

  <NavLink to={config.routes.capmoneyStatistic} className={navBtn}>
    <FaChartPie className="text-[14px]" />
    Thống kê
  </NavLink>

  <NavLink to={config.routes.capmoneyAccount} className={navBtn}>
    <FaWallet className="text-[14px]" />
    Tài khoản
  </NavLink>

  <NavLink to={config.routes.capmoneyBudget} className={navBtn}>
    <FaBullseye className="text-[14px]" />
    Ngân sách
  </NavLink>

  <NavLink to={config.routes.capmoneyPersonal} className={navBtn}>
    <FaUserCircle className="text-[14px]" />
    Cá nhân
  </NavLink>
</nav>
          ...
          <div className="hidden md:block relative" ref={wrapRef}>
            ...
            >
              ...
              <span
                ...
                style={{
                  backgroundImage: `url(${user?.avatar || avatarTrash})`,
