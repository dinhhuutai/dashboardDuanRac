...
const barCard =
  "rounded-3xl bg-white/80 backdrop-blur-xl border border-pink-100 " +
  "shadow-[0_18px_40px_rgba(244,114,182,0.18)]";
        ...
        <div className="px-3">
          <div className={`${barCard} relative h-[62px]`}>
            ...
            <div className="grid grid-cols-5 h-full items-center px-2">
              ...
              <div className="flex justify-center">
                <TabItem
                  to={config.routes.capmoneyStatistic}
                  label="Thống kê"
                  icon={<FaChartPie />}
                />
              </div>
              ...
              <div className="flex justify-center">
                <TabItem
                  to={config.routes.capmoneyAccount}
                  label="Tài khoản"
                  icon={<FaWallet />}
                />
              </div>
              ...
              <div className="flex justify-center">
                <TabItem
                  to={config.routes.capmoneyBudget}
                  label="Ngân sách"
                  icon={<FaBullseye />}
                />
              </div>
              ...
              <div className="flex justify-center">
                <TabItem
                  to={config.routes.capmoneyPersonal}
                  label="Cá nhân"
                  icon={<FaUser />}
                />
              </div>
            ...
            {/* <div className="absolute left-1/2 -translate-x-1/2 -top-6">
              <TabCenter to={config.routes.consolidateTickTime} label="Quét QR" icon={<FaQrcode />} />
            </div> */}
          </div>
        </div>
      </div>
