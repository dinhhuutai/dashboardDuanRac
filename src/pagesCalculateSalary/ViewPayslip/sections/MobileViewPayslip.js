          ...
          <div className={`rounded-3xl px-4 py-4 ${t.cardBg}`}>
            <div className="flex items-start gap-3">
              <div className="flex-1 min-w-0">
                <div className={`text-[20px] font-extrabold ${t.title1}`}>
                  💰 Phiếu{" "}
                  <span className={`${t.title2}`}>
                    {payrollType === "luong" ? "lương" : "thưởng"}
                  </span>
                </div>
            ...
            <div className="mt-3 space-y-3">
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() => onChangePayrollType("luong")}
                ...
                <button
                  type="button"
                  onClick={() => onChangePayrollType("thuong")}
                  className={`h-10 rounded-xl text-sm font-semibold border ${
                    payrollType === "thuong"
                      ? "bg-emerald-600 text-white border-emerald-600"
                      : "bg-white text-slate-700 border-slate-300"
              ...
              {payrollType === "luong" ? (
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={onPrevSalary}
                    disabled={!canPrevSalary || loading}
                    className="h-11 w-11 rounded-xl border bg-white disabled:opacity-40 grid place-items-center"
                  >
                    <FaChevronLeft />
                  </button>

                  <div className="flex-1 h-11 rounded-xl border bg-white px-3 flex items-center justify-center text-[13px] font-semibold text-center">
                    {currentSalaryLabel}
                  </div>

                  <button
                    type="button"
                    onClick={onNextSalary}
