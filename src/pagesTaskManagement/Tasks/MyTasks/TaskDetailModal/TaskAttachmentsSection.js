      ...
      <div className="border-t border-slate-200 pt-3 mt-3 space-y-2">
        ...
        <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
          ...
          {fileAttachments.map((att) => (
            <div
              key={att.attachmentId}
              className="flex items-center justify-between gap-2 px-2 py-1.5 rounded-lg bg-slate-50 border border-slate-200 text-[11px]"
            >
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="inline-flex items-center px-2 py-0.5 rounded-full border border-slate-200 bg-white text-[10px] text-slate-700 hover:bg-slate-50"
                >
                  ⬇ Tải
                </button>
                ...
                <button
                  ...
                  className="inline-flex items-center px-2 py-0.5 rounded-full border border-rose-200 bg-rose-50 text-[10px] text-rose-600 hover:bg-rose-100"
                >
                  ✕ Xoá
                </button>
              </div>
        ...
        <div className="mt-2 flex md:flex-row md:items-start gap-2">
          ...
          <div className="mt-2 md:mt-0 flex flex-col items-start gap-2">
            <button
              ...
              className="inline-flex items-center rounded-full border border-indigo-500 bg-indigo-600 px-3 py-1.5 text-[11px] font-semibold text-white shadow-sm disabled:opacity-50"
            >
