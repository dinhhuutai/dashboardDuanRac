  ...
  return (
    <div className="w-full h-full overflow-y-auto scrollbar-admin-sidebar scrollbar-admin-sidebar-none shadow-[inset_0_0_0_1px_rgba(0,0,0,0.04)]">
      <div className="px-4 pt-3 pb-5">
        {/* Module label */}
        <div className="mb-3">
          <span className="uppercase text-[#3F69D6] text-[11px] font-bold">Menu</span>
        </div>
        ...
        {/* ===== Nhóm: Vận hành ===== */}
        {
          <div className="rounded-lg p-3 bg-white ring-1 ring-slate-200/60 shadow-sm">
            ...
            {openOperate && (
              <SectionCard>
                {
                  <NavLink to={config.routes.adminHistoryConsolidate} className={linkClass}>
                    <FaClipboardCheck className="text-[16px]" />
                    <span>Lịch sử</span>
                  </NavLink>
                }
